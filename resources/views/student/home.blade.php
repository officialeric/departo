    ...
    <section class="flex justify-center text-center bg-white mt-12">
        <div class=" max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 ">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <a href="{{ url('compose') }}" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                     Compose
    ...
    <footer class="p-4 bg-gray-50 sm:p-6 mt-24">
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">Departo</a>. All Rights Reserved.
                </span>
